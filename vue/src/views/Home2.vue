    ...
    <el-menu :default-openeds="['1', '3']">
      <el-submenu index="1">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="1-2">当前资产</el-menu-item>
      ...
      <el-submenu index="2">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="2-8">选项8</el-menu-item>
          <el-menu-item index="2-9">选项9</el-menu-item>
          <el-menu-item index="2-10">选项10</el-menu-item>
